        ...
        {done ? (
          <div className="py-4 text-center">
            ...
            <p className="mt-3 text-[#5C4A38]">
              Our evaluation team will reach out by <strong>August 10</strong>. Three Atlanta founders will be chosen for the August 20 morning — completely free.
            </p>
            <button
              type="button"
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-[#5C4A38]">
                We're setting up 3 Atlanta entrepreneurs in business — absolutely free — on August 20. Tell us about you. Our evaluation team will get back to you by <strong>August 10</strong>.
              </DialogDescription>
            </DialogHeader>
