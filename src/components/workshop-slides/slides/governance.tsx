    ...
    render: () => (
      <SlideLayout stageKicker={KICKER} pageLabel={pl(1)} variant="dark">
        <div className="max-w-[1400px]">
          ...
          <SlotText slideId="cover" field="subtitle" defaultValue="The structure that lets you sleep — and lets the business outlive a bad week. Governance protects what Finance is building." as="p" className="slide-subtitle mt-10 text-white/80 max-w-[1200px]" />
      ...
      <SlideLayout stageKicker={KICKER} pageLabel={pl(2)}>
        <div className="max-w-[1500px]">
          ...
          <h2 className="slide-title font-semibold tracking-tight">
            <SlotText slideId="stakes" field="title" defaultValue="Governance is boring on a good day and priceless on a bad one — it's how a startup survives surprise." />
          </h2>
          <SlotText slideId="stakes" field="body" defaultValue="Get this right and the business can take a hit, a hire, a partner, or a payout without unraveling. Skip it and the first real problem turns into the last one." as="p" className="slide-body-lg mt-10 text-muted-foreground max-w-[1300px]" />
    ...
    render: () => (
      <SlideLayout stageKicker={KICKER} pageLabel={pl(3)}>
        <div>
          ...
          <SlotText slideId="what-breaks" field="title" defaultValue="Three expensive mistakes Governance prevents." as="h2" className="slide-title font-semibold tracking-tight mb-14" />
    ...
    render: () => (
      <SlideLayout stageKicker={KICKER} pageLabel={pl(4)}>
        <div className="max-w-[1500px]">
          ...
          <SlotText slideId="what-good" field="title" defaultValue="A founder who can answer four questions with a binder, not a guess." as="h2" className="slide-title font-semibold tracking-tight mb-12" />
      ...
      return (
        <SlideLayout stageKicker={KICKER} pageLabel={pl(TOTAL_SLIDES)} variant="dark">
          <div className="max-w-[1500px]">
            ...
            <SlotText slideId="recap" field="title" defaultValue="Governance is the quiet armor that makes everything else worth building." as="h2" className="slide-title font-semibold tracking-tight" />
