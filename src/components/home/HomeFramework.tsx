    ...
    <section className="border-t border-white/5 py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <p className="mt-4 max-w-3xl text-base text-muted-foreground md:text-lg">
          Your offer priced, your first customer named, your first channel open, and the outreach that opens week one already written. Everything you need to be selling by Monday — worked out with Adam in the room, not generated by a bot in a browser tab. {WORKSHOP_PRICE_LABEL} once, yours to run with.
        </p>
