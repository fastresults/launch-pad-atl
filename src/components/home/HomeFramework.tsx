    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-16 md:py-24 lg:py-32">
        ...
        <p className="mt-5 max-w-2xl text-base text-white/90 md:mt-6 md:text-lg">
          The 14-Day Launch Method is the done-with-you method quietly replacing accelerators, courses, and raw AI — the playbook modern founders are using to skip the year of guessing and land their first paying customer in two weeks. Run live by Adam, the operator who built it, in one focused morning. {WORKSHOP_PRICE_LABEL} once, yours forever.{" "}
