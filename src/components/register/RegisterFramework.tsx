...
export function RegisterFramework() {
  ...
  const ctx = buildWorkshop
    ...
    : {
        ...
        heroBlurb: "The done-with-you method replacing accelerators, courses, and raw AI. One morning with Adam — offer priced, first customer named, outreach going out that afternoon. Fourteen days to first revenue. Coffee and refreshments on us.",
        asideBlurb: "One live morning inside The 14-Day Launch Method with Adam Anderson — small cohort, real business built. Not another course. Not raw AI. The done-with-you method replacing both.",
