  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-base leading-[1.8] text-foreground/90">
        ...
        <blockquote className="border-l-[3px] border-primary pl-5 italic font-semibold text-xl tracking-tight leading-snug md:text-2xl text-foreground">
