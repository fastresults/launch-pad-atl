  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 font-body text-base leading-[1.8] text-foreground/90">
        ...
        <p>
          In 2009, he co-founded OPEN Interactive, a full-service digital agency and event production company now headquartered in Georgia. He is the originating architect of the Caribbean Investment Summit, a premier convergence event for global wealth migration and citizenship-by-investment that he has grown into a multi-government, multi-sponsor regional institution.
        </p>
        ...
        <p>
          Today, Adam is Founder & CEO of Ampfli, an AI-powered content intelligence platform, and is building the Institute of AI Professionals (IAIP) — a global standards body for AI practitioners. He actively ships SaaS products using Claude, Lovable.dev, Supabase, and fal.ai, and teaches from a hands-on playbook built in the field — not borrowed from a textbook.
        </p>
      </div>
    </motion.section>
  );
