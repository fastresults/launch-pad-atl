  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 font-body text-base leading-[1.8] text-foreground/90">
        ...
        <p>
          <span className="font-display font-bold text-foreground">Frontier.</span> Today Adam is Founder & CEO of Ampfli (<a href="https://askeve.io" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-4">askeve.io</a>), an AI-powered content intelligence platform, and is building the Institute of AI Professionals (<a href="https://theiaip.com/" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-4">theiaip.com</a>) — a global standards body for AI practitioners with founding chapters across five world regions. He ships SaaS on the bleeding edge — composing frontier LLMs, agentic frameworks, AI-native code generation, vector databases, and serverless edge infrastructure — and walks workshop audiences through the same live toolchain he uses in production each day.
        </p>
      </div>
    </motion.section>
  );
