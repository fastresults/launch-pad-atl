...
const SAMPLE_CONCEPTS: { company: string; url: string; concept: string; diff: string }[] = [
  {
    company: "Loop",
    url: "https://loopfeedback.io",
