      ...
      <section className="border-b border-white/5 py-12 md:py-20">
        <div className="mx-auto max-w-4xl px-6">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-gradient-brand md:text-sm md:tracking-[0.2em]">
            One Saturday morning · Full agenda
          </p>
          ...
          <h1 className="text-4xl font-semibold leading-tight tracking-tight md:text-5xl lg:text-6xl">
            Idea in. <span className="text-gradient-brand">Business out.</span>
          </h1>
          <p className="mt-4 max-w-2xl text-base text-muted-foreground md:mt-5 md:text-lg">
            Here's what one Saturday morning with us looks like — every stop on the clock, so you know exactly what you're signing up for. You'll start with your idea in a notebook and leave with your plan, your first customer named, and your first email ready to send that afternoon.{" "}
            <strong className="text-foreground">Nothing generated by a bot.</strong> Every piece worked out with Adam and the team, one-on-one.
          </p>
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-16 rounded-2xl border border-white/10 bg-card p-6 text-center md:p-10">
            ...
            <h3 className="text-2xl font-semibold tracking-tight md:text-3xl">
              Idea in. Business out.
            </h3>
            <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
              Show up at 8:45 with your idea. Leave at 11:30 with your prices set, your first customer named, a way to reach them, and an email ready to send that afternoon — worked out with a real person, not a bot.
            </p>
