        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 border-t border-white/10 pt-6 sm:grid-cols-3 md:mt-10 md:pt-8">
            {[
              ...
              { stat: "Real page copy", label: "written line by line, before you leave" },
            ].map((s) => (
              <div
                key={s.label}
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-8 rounded-2xl border border-primary/25 bg-primary/5 p-5 md:p-6">
            ...
            <p className="text-sm text-foreground/90 md:text-base">
              ...
              <strong>build session</strong>: you bring what you've written so far, Adam or someone on our team writes the next piece with you — the page copy, the priced offer, the outreach message — and you leave with the actual words, not notes about them.
            </p>
          </div>
