        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-16 rounded-2xl border border-white/10 bg-card p-6 text-center md:p-10">
            ...
            <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
              Idea in at 8:45 AM. By 11:30 you leave with your offer priced, your first customer named, your first channel open, and outreach ready to send that afternoon — worked out with the operator, not generated by a bot.
            </p>
