      ...
      <section className="border-b border-white/5 py-12 md:py-20">
        <div className="mx-auto max-w-4xl px-6">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-gradient-brand md:text-sm md:tracking-[0.2em]">
            One focused morning · Full agenda
          </p>
          ...
          <p className="mt-4 max-w-2xl text-base text-muted-foreground md:mt-5 md:text-lg">
            Here's what one focused morning with us looks like — every stop on the clock, so you know exactly what you're signing up for. You'll start with your idea in a notebook and leave with a live page at your domain, your first customer named on a priced offer, and your first outreach message sent from your inbox before you go.{" "}
            <strong className="text-foreground">Nothing generated by a bot and handed to you.</strong> Every piece actually built with Adam and the team, one-on-one, in the room.
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 border-t border-white/10 pt-6 sm:grid-cols-3 md:mt-10 md:pt-8">
            {[
              ...
              { stat: "1 morning", label: "your startup actually built and live" },
              { stat: "Real page", label: "at your domain, up before you leave" },
            ].map((s) => (
              <div
                key={s.label}
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-8 rounded-2xl border border-primary/25 bg-primary/5 p-5 md:p-6">
            ...
            <p className="text-sm text-foreground/90 md:text-base">
              <strong>The first stop is Foundation</strong> — we lock the story of your startup in plain English, on the spot. Every stop after is a{" "}
              <strong>build session</strong>: you bring what you've written so far, Adam or someone on our team actually builds the next piece with you — the page, the priced offer, the first outreach — and you leave with the thing itself, not notes about it.
            </p>
          </div>
          ...
          <div className="mt-16 rounded-2xl border border-white/10 bg-card p-6 text-center md:p-10">
            ...
            <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
              Show up at 8:45 with your idea. Leave at 11:30 with your page live at your domain, your offer priced, your first customer named on it, and your first outreach sent from your inbox — every piece actually built with a real person, not a bot.
            </p>
