...
function WalkInWalkOut() {
  ...
  const walkOut = [
    ...
    "Your funding path picked, a 12-month money plan, a one-page raise summary, and 10 named lenders or investors to contact",
    "A one-page research brief on your idea — market size, trends, rules and permits, suppliers and competitors, and 5 real customer quotes with the links",
    ...
    "A signed go / pivot / kill score for your idea across 6 areas, with the proof behind each score",
    ...
    "Three written playbooks for your business — how a sale comes in, how you deliver it, how a new customer is welcomed — loaded into your project hub",
