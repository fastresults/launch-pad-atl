...
/**
 * Convert an `incomePotential` string like "$10k–$25k / mo" into an annual range.
 * Handles /mo, /season, /yr, per-location suffixes, and qualifiers in parens.
 */
export function toAnnualRange(incomePotential: string): string {
  if (!incomePotential) return "";
  // Extract qualifier in parens e.g. "(seasonal)", "(after 6 mo)"
  const qualifierMatch = incomePotential.match(/\(([^)]+)\)/);
  const qualifier = qualifierMatch ? ` (${qualifierMatch[1]})` : "";

  // Extract numeric range
  const nums = Array.from(incomePotential.matchAll(/\$?(\d+(?:\.\d+)?)(k|K|m|M)?/g));
  if (nums.length === 0) return incomePotential;
  const toNumber = (m: RegExpMatchArray) => {
  ...
  const low = toNumber(nums[0]);
  const high = nums.length > 1 ? toNumber(nums[1]) : low;

  const per = incomePotential.toLowerCase();
  let multiplier = 12;
  if (per.includes("/ yr") || per.includes("/yr") || per.includes("/ year")) multiplier = 1;
  else if (per.includes("season")) multiplier = 1; // seasonal totals are already the season
  else if (per.includes("/ mo") || per.includes("/mo")) multiplier = 12;
  ...
  const perLocation = per.includes("per location") ? " per location" : "";
  const range = annualLow === annualHigh ? fmt(annualLow) : `${fmt(annualLow)}–${fmt(annualHigh)}`;
  return `${range} / yr${perLocation}${qualifier}`;
}
...
export const BUSINESS_IDEAS: BusinessIdea[] = [
  // ============== ONLINE (16) ==============
  {
    ...
    idealOperator: "Ex-service industry pro who's great on the phone and wants a laptop business.",
    whySmart: "Trades lose ~30% of after-hours calls. You plug the leak for less than one missed job.",
  },
  {
    ...
    idealOperator: "Numbers person or bookkeeper who wants recurring revenue from a hot niche.",
    whySmart: "Med-spas are booming and hate their books. 10 retainers = full-time income.",
  },
  {
    ...
    idealOperator: "Strong writer who can channel a founder's voice and hit publish on time.",
    whySmart: "Execs want a personal brand and no time to build it. 4 clients = $10k/mo.",
  },
  {
    ...
    idealOperator: "Introvert-friendly builder who can research a niche and ship weekly.",
    whySmart: "AI cuts production 10x. Compounding library sells the course while you sleep.",
  },
  {
    ...
    idealOperator: "Design-minded operator who's shipped a Shopify store or two before.",
    whySmart: "Etsy fees are killing makers. Owning a store is a clear, urgent upgrade.",
  },
  {
    ...
    idealOperator: "Organized generalist who loves cleaning things up and using AI tools.",
    whySmart: "Every SMB owner drowns in email. $300/mo is a no-brainer to buy back 5 hrs/wk.",
  },
  {
    ...
    idealOperator: "Systems thinker who lives in Notion and enjoys translating chaos into order.",
    whySmart: "Local SMBs are still running on paper and texts. One clean dashboard = hero status.",
  },
  {
    ...
    idealOperator: "Insider in a specific world who reads 3 hrs/day on it already.",
    whySmart: "Attention in a real niche is worth 10x general audience — sponsors pay premiums.",
  },
  {
    ...
    idealOperator: "Crafty parent who can batch make evenings/weekends from a spare room.",
    whySmart: "Evergreen gifting niche with Etsy's built-in traffic. Low unit cost, high margin.",
  },
  {
    ...
    idealOperator: "Content person who can turn a listing into 5 assets in an afternoon.",
    whySmart: "Agents pay for leads — content = leads. 10 agents/brokerage = $7k/mo per shop.",
  },
  {
    ...
    idealOperator: "Extrovert with an eye for value and stamina to talk on-camera for 2 hrs a night.",
    whySmart: "Whatnot brings the audience. You just need great picks and a good voice.",
  },
  {
    ...
    idealOperator: "Former teacher or top student who's patient with kids and parents.",
    whySmart: "Parents will always pay for their kid's test scores. AI cuts prep time in half.",
  },
  {
    ...
    idealOperator: "Neighborhood-friendly bookkeeper who can talk shop with barbers.",
    whySmart: "Cash-heavy businesses hate the IRS. Recurring $250/mo × 20 shops = full income.",
  },
  {
    ...
    idealOperator: "Systems-savvy builder who's watched contractors struggle with paperwork.",
    whySmart: "Digital product, zero delivery cost. Build once, sell forever, upsell later.",
  },
  {
    ...
    idealOperator: "Salesy operator who can cold-call trades and set up AI outreach.",
    whySmart: "Trades pay $500+ per lead. $1,500/mo is cheaper than one bad Google Ads week.",
  },
  {
    ...
    idealOperator: "Camera-shy creator with editing chops and daily discipline.",
    whySmart: "TikTok Shop is throwing money at creators. Faceless = compounding library.",
  },
  ...
  // ============== MAIN STREET (14) ==============
  {
    ...
    idealOperator: "Hands-on hustler who takes pride in a clean car and doesn't mind heat.",
    whySmart: "Convenience premium — busy families pay to skip the drive to a car wash.",
  },
  {
    ...
    idealOperator: "Small-biz owner who wants a semi-passive route with 1-hr weekly restocks.",
    whySmart: "Captive audience, no barista, no rent. Stack 3 locations = real income.",
  },
  {
    ...
    idealOperator: "Route-runner who likes stacking small monthly profits into a real machine.",
    whySmart: "Cash flow starts week 1. Fully sellable asset — routes trade at 2–3× annual.",
  },
  {
    ...
    idealOperator: "Night-owl hustler who likes physical work with instant, visible results.",
    whySmart: "Recurring monthly contracts. Before/after photos sell themselves.",
  },
  {
    ...
    idealOperator: "Licensed nail tech who wants their own book without a full lease.",
    whySmart: "Skip the salon buildout — start earning weekend one with a $200 chair rental.",
  },
  {
    ...
    idealOperator: "Golf lover with a truck who's happy running events on weekends.",
    whySmart: "One trailer covers 20-mile radius. Bars & breweries pay to fill slow nights.",
  },
  {
    ...
    idealOperator: "Personable host with weekend energy and a safety-first mindset.",
    whySmart: "Corporate team-build budget is huge. One booking = $500–$1,000 for a night.",
  },
  {
    ...
    idealOperator: "Skilled braider with patience for 4–6 hr sessions and a strong IG game.",
    whySmart: "High-ticket service, loyal repeat clients, near-zero overhead from home.",
  },
  {
    ...
    idealOperator: "Groomer who loves dogs more than desk work and wants to own the schedule.",
    whySmart: "Dog owners pay premium to skip the salon. Books out 4 weeks in most metros.",
  },
  {
    ...
    idealOperator: "Detail-obsessed operator who doesn't mind traveling to the boat/lot.",
    whySmart: "Boat/RV owners have money and hate cleaning. Repeat every 60–90 days.",
  },
  {
    ...
    idealOperator: "Wellness-community-connected host who loves curating and hosting tastings.",
    whySmart: "NA drinks are the fastest-growing bev category. Pop-up = test before a lease.",
  },
  {
    ...
    idealOperator: "Route-runner comfortable on ladders who wants recurring quarterly work.",
    whySmart: "Solar installs doubled in 5 years — no one else has built a maintenance route.",
  },
  {
    ...
    idealOperator: "Green-thumb hobbyist who likes weekly delivery routines from a spare room.",
    whySmart: "10-day grow cycle, high margins, chefs pay $30+/lb, low competition locally.",
  },
  {
    ...
    idealOperator: "Rated player who's a natural teacher and enjoys running groups outdoors.",
    whySmart: "Fastest-growing sport in US. Almost no certified coaches — huge open lane.",
  },
  ...
  // ============== SERVICE (14) ==============
  {
    ...
    idealOperator: "Strong-back operator who's comfortable running a crew of 1–2 helpers.",
    whySmart: "Same-day cash, referral-heavy, and realtors send steady estate cleanout work.",
  },
  {
    ...
    idealOperator: "Handy operator who's OK with a 2-week certification and steady route work.",
    whySmart: "Insurance pays direct. Body shops keep you booked without marketing spend.",
  },
  {
    ...
    idealOperator: "Detail-focused installer who can lead a 2-person crew through 1-day jobs.",
    whySmart: "High-ticket, single-day, obvious upgrade. Before/afters print money on FB.",
  },
  {
    ...
    idealOperator: "Wellness operator partnered with an RN who handles the clinical side.",
    whySmart: "Bachelorettes, hangovers, execs. Concierge health is a fast-growing category.",
  },
  {
    ...
    idealOperator: "Aesthetic-minded organizer with an IG eye and calm client-facing energy.",
    whySmart: "Home Edit made this mainstream. Wealthy families pay $3k+ per room without blinking.",
  },
  {
    ...
    idealOperator: "Patient explainer who's great with seniors and knows Apple + Android well.",
    whySmart: "Massive underserved market. One happy client tells the whole church.",
  },
  {
    ...
    idealOperator: "Trustworthy caregiver-type who's reliable, insured, and warm.",
    whySmart: "Aging population + adult kids in another state = permanent, growing demand.",
  },
  {
    ...
    idealOperator: "Detail-oriented professional with a reliable car and clean background check.",
    whySmart: "Real-estate closings never stop. $150 for 45 minutes of work — do 3/day.",
  },
  {
    ...
    idealOperator: "Pet-obsessed operator who loves being outside and keeping to a schedule.",
    whySmart: "Repeat weekly bookings + holiday overnight boarding = predictable cash flow.",
  },
  {
    ...
    idealOperator: "Outdoor operator who thinks in routes and stacks houses tight to save drive time.",
    whySmart: "Every skipped house on a route is pure margin. Density beats price.",
  },
  {
    ...
    idealOperator: "Salesy connector who can partner with one great electrician and chase leads.",
    whySmart: "EV sales climbing 30%/yr. Referral-only means zero tools, pure sales margin.",
  },
  {
    ...
    idealOperator: "Seasonal hustler who wants a 90-day sprint that funds the rest of the year.",
    whySmart: "$50k in 90 days, then 9 months free. Rebook 80% of clients auto next October.",
  },
  {
    ...
    idealOperator: "Connected church member with taste, calm nerves, and a rolodex of vendors.",
    whySmart: "One pastor's endorsement = 20 weddings/yr. Faith communities are tight-knit.",
  },
  {
    ...
    idealOperator: "Tech-comfy creative with a Part 107 drone license and steady hands.",
    whySmart: "Every listing needs this now. One brokerage = 30 agents = recurring flow.",
  },
  ...
  // ============== FOOD & HANDS (7) ==============
  {
    ...
    idealOperator: "Line-cook or food-obsessed operator who knows one dish cold.",
    whySmart: "Skip the dining room. DoorDash brings hungry buyers to a $500/mo kitchen.",
  },
  {
    ...
    idealOperator: "Chef-hustler who can prep 150 lunches by 10am and deliver by noon.",
    whySmart: "Office managers rebook indefinitely if lunch is on-time and tasty. Zero marketing.",
  },
  {
    ...
    idealOperator: "Home cook who plans menus, batches efficiently, and lives near the customers.",
    whySmart: "Weeknight dinner is the #1 pain point for working moms. Referrals sell themselves.",
  },
  {
    ...
    idealOperator: "Baker who loves the ritual and can hit the same quality every week.",
    whySmart: "Recurring subs = predictable weekly dough (literally). Underserved allergy niche.",
  },
  {
    ...
    idealOperator: "Home cook with a signature cuisine and Friday-only availability.",
    whySmart: "One prep day, one drop-off. Perfect side hustle that scales to a truck.",
  },
  {
    ...
    idealOperator: "Patient decorator with an artistic streak and Insta-worthy final products.",
    whySmart: "Weddings pay premium for pretty. One planner partnership = a booked season.",
  },
  {
    ...
    idealOperator: "Health-focused operator with early-morning energy and a local delivery route.",
    whySmart: "Wellness crowd pays weekly on autopilot. Partner with 3 studios = full route.",
  },
  ...
  // ============== SIDE → FULL-TIME (5) ==============
  {
    ...
    idealOperator: "Content creator with editing chops who can turn 1 shoot day into 12 reels.",
    whySmart: "Med-spa margins are massive. $2k/mo is a rounding error for real ROI.",
  },
  {
    ...
    idealOperator: "Analytical operator who enjoys spreadsheets, sourcing calls, and margins.",
    whySmart: "Amazon does the traffic + fulfillment. You just find the right SKU.",
  },
  {
    ...
    idealOperator: "Ex-recruiter or strong writer who understands what hiring managers want.",
    whySmart: "Layoffs = endless demand. 5 clients/wk × $450 = quit-your-job money.",
  },
  {
    ...
    idealOperator: "Warm public speaker who loves telling love stories and staying calm on the day.",
    whySmart: "Weekend-only work, near-zero costs, and reviews compound fast.",
  },
  {
    ...
    idealOperator: "Editor who can turn phone footage into polished reels in under an hour each.",
    whySmart: "Realtors need content and hate editing. Recurring monthly = stable ladder up.",
  },
  ...
  // ============== FAMILY-RUN (4) ==============
  {
    ...
    idealOperator: "Handy spouse + organized partner who splits jobs and dispatch cleanly.",
    whySmart: "Two trucks doubles revenue without doubling overhead. Family = trusted crew.",
  },
  {
    ...
    idealOperator: "Detail-loving couple: one runs guests + turnovers, other handles ops + finances.",
  ...
  },
  {
    ...
    idealOperator: "Reliable family team that can do 3–4 turnovers same-day on weekends.",
    whySmart: "Hosts need same-day, trustworthy crews. Book 40 turnovers/mo = full income.",
  },
];
