...
export const AGENCY_SERVICES: AgencyService[] = [
  {
    ...
    priceLabel: "Scoped to your startup",
    timelineLabel: "Timeline set in discovery",
  ...
  },
  {
    ...
    priceLabel: "Scoped setup + monthly retainer",
    timelineLabel: "Cadence set in discovery",
  ...
  },
  {
    ...
    priceLabel: "Scoped monthly retainer",
    timelineLabel: "Ongoing — cadence set in discovery",
  ...
  },
  {
    ...
    priceLabel: "Scoped to your workflows",
    timelineLabel: "Timeline set in discovery",
  ...
  },
  {
    ...
    priceLabel: "Scoped to your stack",
    timelineLabel: "Timeline set in discovery",
  ...
  },
  {
    ...
    priceLabel: "Scoped to your motion",
    timelineLabel: "Timeline set in discovery",
  ...
  },
  {
    ...
    priceLabel: "Scoped to your entity + state",
    timelineLabel: "Timeline set in discovery",
