...
> = {
  "brand-identity": {
    chipLabel: "Brand",
    opensLabel: "Sep 2026",
    heroQuestion: "What should people feel when they find you?",
    promptExamples: [
      "Trustworthy enough to hand over my house keys",
      "Warm neighborhood bakery, not a chain",
      "Serious enough for a $40k contract",
    ],
  ...
  "website-that-converts": {
    chipLabel: "Website",
    opensLabel: "Oct 2026",
    heroQuestion: "What should your site get someone to do?",
    promptExamples: [
      "Book a quote without calling me",
      "Buy the $89 starter box",
      "Schedule a walkthrough this week",
    ],
    inputLabel: "Tell us the one thing your site should do",
  ...
  "sales-systems": {
    chipLabel: "Sales",
    opensLabel: "Nov 2026",
    heroQuestion: "What kind of clients do you want?",
    promptExamples: [
      "Property managers with 20+ units",
      "Busy families in Gwinnett who hate cleaning",
      "Small law firms that need a real bookkeeper",
    ],
    inputLabel: "Tell us the clients you want",
  ...
  "email-crm-automation": {
    chipLabel: "Email & CRM",
    opensLabel: "Dec 2026",
    heroQuestion: "Who's slipping through the cracks right now?",
    promptExamples: [
      "People who ask for a quote and go quiet",
  ...
  "social-presence": {
    chipLabel: "Social",
    opensLabel: "Jan 2027",
    heroQuestion: "Where do your customers already spend their time?",
    promptExamples: [
      "Instagram, but I post twice a year",
      "Facebook groups in my county",
      "LinkedIn — my buyers are operations managers",
    ],
    inputLabel: "Tell us where your customers already are",
  ...
  "content-engine": {
    chipLabel: "Content",
    opensLabel: "Feb 2027",
    heroQuestion: "What do people ask you before they buy?",
    promptExamples: [
      "How much does a full kitchen remodel cost?",
      "Is this safe for my dog?",
      "How fast can you actually get here?",
    ],
    inputLabel: "Tell us what people ask before they buy",
  ...
  "ai-operating-system": {
    chipLabel: "AI ops",
    opensLabel: "Mar 2027",
    heroQuestion: "What are you doing by hand that's eating your week?",
    promptExamples: [
  ...
  "legal-financial-ops": {
    ...
    opensLabel: "Apr 2027",
    heroQuestion: "What's the part you've been avoiding?",
    promptExamples: [
      "I still haven't formed the LLC",
      "No contract — just texts and handshakes",
      "My books are a shoebox and a bank app",
    ],
