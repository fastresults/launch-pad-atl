...
export const VALUE_ROWS: ValueRow[] = [
  { stageN: 1, stageLabel: "Form", deliverable: "GA LLC filing packet — Articles pre-filled, registered agent set", marketCostMin: 225, marketCostMax: 600, diyHoursMin: 3, diyHoursMax: 6, postWorkshop: "Go to the Georgia Corporations Division site (sos.ga.gov). Upload your Articles PDF. Pay the $100 filing fee with a card. Approval email arrives in 5–7 business days." },
  ...
  { stageN: 5, stageLabel: "Brand", deliverable: "Logo + 4-color palette + font pairing", marketCostMin: 375, marketCostMax: 1875, diyHoursMin: 7.5, diyHoursMax: 15, postWorkshop: "Download the logo ZIP. Upload it to your website, email signature, and social profiles. Keep the brand sheet PDF — hand it to anyone making things for you." },
  { stageN: 5, stageLabel: "Brand", deliverable: "Complete 4-page website — branded, written, SEO-configured", marketCostMin: 1500, marketCostMax: 4500, diyHoursMin: 15, diyHoursMax: 30, postWorkshop: "Click Publish in the site builder. Buy your domain (~$12/yr) and connect it — the builder walks you through it step by step. Site goes live in about 30 minutes." },
  { stageN: 5, stageLabel: "Brand", deliverable: "Stripe / Square + GA4 + business email configured", marketCostMin: 225, marketCostMax: 225, diyHoursMin: 3, diyHoursMax: 3, postWorkshop: "Finish Stripe verification (bank routing + SSN, ~5 min). Verify your business email by clicking the link they send. GA4 is already tracking — just log in weekly to check visits." },
  ...
  { stageN: 6, stageLabel: "Marketing", deliverable: "Business card + flyer — print-ready files", marketCostMin: 185, marketCostMax: 185, diyHoursMin: 3, diyHoursMax: 3, postWorkshop: "Upload the print-ready PDFs to Vistaprint or Moo. 500 business cards ≈ $25, 100 flyers ≈ $40. Arrives in 5–7 days." },
  { stageN: 6, stageLabel: "Marketing", deliverable: "6 social posts + 60-second video script + 30-day plan", marketCostMin: 450, marketCostMax: 450, diyHoursMin: 6, diyHoursMax: 6, postWorkshop: "Post one item every 2 days using the schedule we built. Film the 60-second video on your phone using the script — one take is fine. Done beats perfect." },
  ...
  { stageN: 7, stageLabel: "Launch", deliverable: "Day-of timeline + CRM set up + 3 KPIs to track", marketCostMin: 225, marketCostMax: 225, diyHoursMin: 2, diyHoursMax: 2, postWorkshop: "Log in to the CRM each Monday and add every new lead. Check your 3 KPIs every Friday — that's it." },
];
