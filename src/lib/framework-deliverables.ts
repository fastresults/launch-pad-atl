...
export const FRAMEWORK_STAGES: FrameworkStage[] = [
  {
    ...
    items: [
      ...
      { icon: Sparkles, title: "Your AI toolkit, picked for you", tooltip: "Your named AI-first toolkit — the exact tools for writing, site building, CRM, calendar, email, analytics, support, automation, ads, and reviews. You'll stop wasting the first week comparing SaaS and start Day 2 already knowing which links to open." },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Palette, title: "The look you hand to a designer", tooltip: "A clear brief for the logo, colors, type, and visual feel — ready to hand to a designer or an AI tool. You'll skip months of revisions, get an identity you actually love, and look credible from day one." },
      { icon: Mic, title: "How your brand sounds", tooltip: "How your brand sounds — word choice, rhythm, what to avoid — so anyone writing for you sounds like you. Founders, contractors, and AI tools all produce on-brand copy without you rewriting every sentence yourself." },
  ...
  },
  {
    ...
    items: [
      { icon: Globe, title: "The build brief for your website", tooltip: "A complete product requirements asset — pages, copy, sections, calls to action — written so an AI builder can ship your site fast. You'll skip the $20K agency quote and launch a real revenue-ready website fast." },
      ...
      { icon: MousePointerClick, title: "A live page by day 4", tooltip: "A one-page offer test live by day four — before the full site — so paid ads and warm outreach have a destination while you finish building. You'll validate the hook, collect emails, and turn early clicks into paying customers." },
