...
export const FRAMEWORK_STAGES: FrameworkStage[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: ClipboardList, title: "Budget & Pro Forma", tooltip: "A line-by-line budget and forecast tied to real assumptions about your market and pricing. You'll walk into a bank, an SBA meeting, or a landlord conversation with the asset they expect — and be taken seriously immediately." },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: BookOpen, title: "Brand Guidelines Book", tooltip: "One asset that holds your logo rules, colors, type, voice, and examples in one place. Hand it to any vendor, freelancer, or new hire and they'll produce on-brand work without forty rounds of feedback from you." },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Globe, title: "Pre-Sell Landing PRD (AI-builder prompt)", tooltip: "A scoped one-page PRD — sections, copy, form spec, confirmation emails, analytics, brand tokens — written so Lovable, v0, or Bolt scaffolds your Day-4 pre-sell page in one shot. You'll ship the validation page in an afternoon instead of a weekend." },
