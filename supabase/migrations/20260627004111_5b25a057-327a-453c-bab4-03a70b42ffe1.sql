...
BEGIN
  ...
  cleared := cleared || 'attendee_profiles(venture_fields)';

  RETURN cleared;
END;
$$;

GRANT EXECUTE ON FUNCTION public.reset_founder_workspace(uuid) TO authenticated, service_role;
