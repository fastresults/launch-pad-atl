...
const TRACK_TONE: Record<string, string> = {
  ...
  small_business:
    "TRACK — Established Small Business: Write as a seasoned small-business advisor coaching an owner who ALREADY has revenue, customers, and likely staff. Emphasize margin expansion, unit economics, repeat customers, operational discipline, multi-location or franchise economics, and steady regional growth. Reference SBA / bank-financing realities and proven owner-operator playbooks. Avoid venture-capital framing entirely.",
  scalable_tech:
