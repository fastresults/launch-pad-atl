...
const DAYS: Day[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      ["photography", "Choose the real imagery", "Stock and placeholders read as 'nobody works here'.", "Every placeholder on a live surface is replaced with an image that is genuinely yours.", "client", "Creative"],
      ["imagery-production", "Replace stock with owned imagery", "Stock imagery is the loudest tell that a brand is new — owned, art-directed frames are what move it up a tier.", "Every hero surface carries an original image made to the art direction — one light, crop and colour language across the set.", "agency", "Creative"],
