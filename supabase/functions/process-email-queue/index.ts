...
function getRoutingMetadata(payload: Record<string, unknown>): Record<string, unknown> | undefined {
  if (!payload.dev_routed && !payload.original_recipient) {
    return undefined
  }

  return {
    dev_routed: Boolean(payload.dev_routed),
...
async function moveToDlq(
  ...
  await supabase.from('email_send_log').insert({
    ...
    metadata: getRoutingMetadata(payload),
  })
